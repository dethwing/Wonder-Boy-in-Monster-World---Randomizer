...
Attributes = [
        ...
        Attribute(
                ...
                number_of_bytes=1,
                is_little_endian=False,
                possible_values=[ 8, 9, 10,11,12,13,   15     
                                 ]                                 
                ),
        Attribute(
                name="Charm_Guy_3",
                ...
                number_of_bytes=1,
                is_little_endian=False,
                possible_values=[ 16,17,18,19,20,21,22,23      
                                 ]                                 
                ),
        Attribute(
                name="Charm_Guy_4",
                ...
                number_of_bytes=1,
                is_little_endian=False,
                possible_values=[ 24,25,26,27,28,29, 31     
                                 ]                                 
                ),
        Attribute(
                name="Charm_Guy_5",
...
Required_Rules = [
        ...
        Rule(
                ...
                left_side=[ value("Water_Money_Chest3_Item1"),value("Water_Money_Chest3_Item2"),value("Water_Money_Chest3_Item3"),
                            ...
                            value("Legend_Armor"),value("Legend_Shield"),value("Legend_Boots"),value("Bracelet_Item")                           
                            ],
                rule_type="!=",
                right_side=None
        ),
        Rule(
                ...
                left_side=[ (value("Pygmy_Sword"),"=",58),(value("Pygmy_Armor"),"=",58),(value("First_Money"),"=",58),
                            ...
                            (value("Water_Money_Chest2_Item1"),"=",58),(value("Water_Money_Chest2_Item2"),"=",58),
                            (value("Water_Money_Chest2_Item3"),"=",58),(value("Water_Money_Chest2_Item4"),"=",58),
                            (value("Water_Money_Chest2_Item5"),"=",58),(value("Water_Money_Chest2_Item6"),"=",58),
        ...
        Rule(
                ...
                left_side=[ (value("Pygmy_Sword"),"=",26),(value("Pygmy_Armor"),"=",26),(value("First_Money"),"=",26),
                            ...
                            (value("Water_Money_Chest2_Item1"),"=",26),(value("Water_Money_Chest2_Item2"),"=",26),
                            (value("Water_Money_Chest2_Item3"),"=",26),(value("Water_Money_Chest2_Item4"),"=",26),
                            (value("Water_Money_Chest2_Item5"),"=",26),(value("Water_Money_Chest2_Item6"),"=",26),
        ...
        Rule(
                ...
                left_side=[ (value("Pygmy_Sword"),"=",49),(value("Pygmy_Armor"),"=",49),(value("First_Money"),"=",49),
                            ...
                            (value("Water_Money_Chest2_Item1"),"=",49),(value("Water_Money_Chest2_Item2"),"=",49),
                            (value("Water_Money_Chest2_Item3"),"=",49),(value("Water_Money_Chest2_Item4"),"=",49),
                            (value("Water_Money_Chest2_Item5"),"=",49),(value("Water_Money_Chest2_Item6"),"=",49),
